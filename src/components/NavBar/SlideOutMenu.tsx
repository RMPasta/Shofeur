...
export default function SlideOutMenu(): JSX.Element {
  ...
  const ulClassName = "w-3/5 md:w-1/5 h-screen flex flex-col justify-between bg-gray-100 text-gray-800 transition-left duration-700" + (!showMenu ? " w-1/6 absolute -left-80 top-20" : " w-2/5 md:w-1/3 lg:w-1/5 absolute left-0 top-20");
